...
namespace ScreenCapturePushStream
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Setup()
        {
            ...
            visual.Brush = brush;
            ElementCompositionPreview.SetElementChildVisual(CaptureFrame, visual);
        }
        ...
        private void FillSurfaceWithBitmap(CanvasBitmap canvasBitmap)
        {
            ...
            bitmapbytes = canvasBitmap.GetPixelBytes();
        }
        ...
        private void PushStreamBtn_Click(object sender, RoutedEventArgs e)
        {
